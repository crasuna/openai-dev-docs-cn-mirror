...
实现演练请参见 [构建 ChatGPT UI](https://developers.openai.com/apps-sdk/build/chatgpt-ui)。
...
需要了解这些字段的更多背景？请查看 [MCP 服务器指南的高级部分](https://developers.openai.com/apps-sdk/build/mcp-server#advanced)。
...
这些资源设置的更多细节位于 [MCP 服务器指南的高级部分](https://developers.openai.com/apps-sdk/build/mcp-server#advanced)。
...
[MCP 服务器指南的高级部分](https://developers.openai.com/apps-sdk/build/mcp-server#advanced) 对这些响应字段的组织方式提供了更多指导。
...
更广泛的客户端提示背景请参见 [MCP 服务器指南的高级部分](https://developers.openai.com/apps-sdk/build/mcp-server#advanced)。
