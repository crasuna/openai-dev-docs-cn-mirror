...
- 使用 [测试你的集成](https://developers.openai.com/apps-sdk/deploy/testing) 指南验证工具链和遥测。
- 通过 [故障排查](https://developers.openai.com/apps-sdk/deploy/troubleshooting) 准备一份故障排查手册，帮助值班响应人员快速诊断问题。
