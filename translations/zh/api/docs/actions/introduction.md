---
status: needs-review
sourceId: "2d8e7bc2e1c6"
sourceChecksum: "2d8e7bc2e1c625a6ebac240efb76ab7f9b9e99fed5ac9b8a2b4f5cc41e64c6a7"
sourceUrl: "https://developers.openai.com/api/docs/actions/introduction"
...
GPT Actions 让 ChatGPT 用户能够仅使用自然语言，通过 ChatGPT 外部的 RESTful API 调用与外部应用交互。它们会把自然语言文本转换成 API 调用所需的 json schema。GPT Actions 通常用于向 ChatGPT 进行[数据检索](https://developers.openai.com/api/docs/actions/data-retrieval)（例如查询 Data Warehouse），或在另一个应用中执行操作（例如提交 JIRA 工单）。
...
[入门指南](https://developers.openai.com/api/docs/actions/getting-started)会通过 [weather.gov](https://developers.openai.com/api/docs/actions/weather.gov) 的两个 API 调用示例来生成天气预报：
...
查看[入门指南](https://developers.openai.com/api/docs/actions/getting-started)，深入了解这个天气示例；也可以查看我们的 [actions library](https://developers.openai.com/api/docs/actions/actions-library)，获取最常见第三方应用的预构建 GPT Actions 示例。
