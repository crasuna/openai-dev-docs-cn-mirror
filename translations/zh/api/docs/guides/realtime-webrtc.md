---
status: needs-review
sourceId: "b9d64da5d3c6"
sourceChecksum: "b9d64da5d3c6bf21e2c791876b7f4ad71f82ee4d594a4d99a7f1949dc91f4304"
sourceUrl: "https://developers.openai.com/api/docs/guides/realtime-webrtc"
...
对于基于浏览器的 speech-to-speech 语音应用，我们建议从 [Voice agents](https://developers.openai.com/api/docs/guides/voice-agents) 开始，它涵盖了 Agents SDK 用于管理 Realtime sessions 的更高层 helpers 和 API。WebRTC interface 强大且灵活，但比 Agents SDK 更底层。
...
如果你的应用为每个最终用户分配 [safety identifier](https://developers.openai.com/api/docs/guides/safety-best-practices#implement-safety-identifiers)，请在这个
...
通过 WebRTC 连接到 Realtime model 时，你不需要像使用 [WebSockets](https://developers.openai.com/api/docs/guides/realtime-websocket) 那样以同样细粒度处理来自模型的音频事件。如果按上面方式配置，WebRTC peer connection object 会为你完成这些工作。
...
要进一步了解如何管理 Realtime conversations，请参阅 [Realtime conversations guide](https://developers.openai.com/api/docs/guides/realtime-conversations)。
