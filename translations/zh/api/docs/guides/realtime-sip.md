---
status: needs-review
sourceId: "ae0f46a3228c"
sourceChecksum: "ae0f46a3228c458b19a54a91cb902693c4cdff01d6ba146b2cc3e4d28be2998d"
sourceUrl: "https://developers.openai.com/api/docs/guides/realtime-sip"
...
首先，请通过 **platform.openai.com** [settings](https://platform.openai.com/settings) > Project > **Webhooks** 为传入呼叫创建一个 [webhook](https://developers.openai.com/api/docs/guides/webhooks)。
...
跟踪进度。更多信息请参阅 [Webhooks and server-side controls](https://developers.openai.com/api/docs/guides/realtime-server-controls)。
