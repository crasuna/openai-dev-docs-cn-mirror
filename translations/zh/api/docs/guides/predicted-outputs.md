---
status: needs-review
sourceId: "3ce8641a58c2"
sourceChecksum: "3ce8641a58c274b3eab8567f6cfe70ba3828c3b36827bfe87693ef48813aa1f1"
sourceUrl: "https://developers.openai.com/api/docs/guides/predicted-outputs"
...
- 使用 Predicted Outputs 时，不支持以下 [API parameters](https://developers.openai.com/api/docs/api-reference/chat/create)：
  ...
  - `audio`：Predicted Outputs 与 [audio inputs and outputs](https://developers.openai.com/api/docs/guides/audio) 不兼容
