---
status: needs-review
sourceId: "433b517f8fa3"
sourceChecksum: "433b517f8fa3dc9b806784abe3968a74be6f8378621f7b23121bec101792db8f"
sourceUrl: "https://developers.openai.com/codex/enterprise/access-tokens"
...
需要从你自己的系统触发已发布的 ChatGPT workspace agent？请改用 Workspace Agents API 的 Workspace Agent 访问令牌。Codex 访问令牌用于认证 Codex 本地工作流；它们不能认证 workspace agent 触发调用。请参阅[使用 Workspace Agent 访问令牌进行认证](https://developers.openai.com/workspace-agents/authentication)。
