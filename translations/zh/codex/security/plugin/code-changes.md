---
status: needs-review
sourceId: "da57fec21295"
sourceChecksum: "da57fec212953b02228c73bf8f6bc20fea5a665213ab6258f508000577c1c2ac"
sourceUrl: "https://developers.openai.com/codex/security/plugin/code-changes"
...
如果你想扫描完整 repository，而不是特定变更，请参见 [Run a security scan](https://developers.openai.com/codex/security/plugin/scans)。
...
审查结果后，[修复并验证已接受发现项](https://developers.openai.com/codex/security/plugin/fix-findings)，或[导出并跟踪发现项](https://developers.openai.com/codex/security/plugin/export-findings)。
...
关于 API-key handling、sandbox controls、fork protections 和 GitHub Actions workflow，请参见 [Codex GitHub Action guide](https://developers.openai.com/codex/github-action)。
