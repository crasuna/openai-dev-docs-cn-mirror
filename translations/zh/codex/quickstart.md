---
status: needs-review
sourceId: "459281f19389"
sourceChecksum: "459281f19389096b9a8f1ceac37ca7c84e9b610dc834bc86eaa1a7b09f1a91b4"
...
4. 发送第一条消息
   ...
   如果你刚开始使用 Codex，请阅读 [best practices guide](https://developers.openai.com/codex/learn/best-practices)。
...
4. 使用 Git checkpoints
    ...
    <CtaPillLink href="/codex/ide" label="进一步了解 Codex IDE extension" class="mt-8" />
</WorkflowSteps>
...
1. 安装 Codex CLI
    ...
    对于 unattended installs，请在运行下载 installer 的 shell 上设置 `CODEX_NON_INTERACTIVE=1`。详情参见 [Environment variables](https://developers.openai.com/codex/environment-variables#installer-variables)。
...
4. 使用 Git checkpoints
    ...
    <CtaPillLink href="/codex/cli" label="进一步了解 Codex CLI" class="mt-8" />
...
4. 审查变更并创建 pull request
    ...
    <CtaPillLink href="/codex/cloud" label="进一步了解 Codex cloud" class="mt-8" />
</WorkflowSteps>
...
[<IconItem title="进一步了解 Codex app" className="mt-2">
    <span slot="icon">
      <OpenBook />
    </span>
...
[<IconItem title="迁移到 Codex" className="mt-2">
    <span slot="icon">
      <CompareArrows />
    </span>
