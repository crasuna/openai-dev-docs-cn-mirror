...
| ------------------- | -------- | ------------ |
| `pid`               | Yes      | 你的 Pixel ID。 |
| `event`             | Yes      | 一个[受支持的 event name](https://developers.openai.com/ads/supported-events)，或 `custom`。 |
...
| `data[type]`        | Yes      | event 所需的 [data type](https://developers.openai.com/ads/supported-events#event-data-shapes)。 |
