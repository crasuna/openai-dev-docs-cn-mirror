...
::: warning 非官方本地镜像
- 官方来源：[https://developers.openai.com/apps-sdk/deploy/submission](https://developers.openai.com/apps-sdk/deploy/submission)
- Markdown 来源：[https://developers.openai.com/apps-sdk/deploy/submission.md](https://developers.openai.com/apps-sdk/deploy/submission.md)
- 抓取时间：2026-06-27T05:54:46.952Z
- Checksum：`2cfc13baf207496cf959da081714b164472bdf5bbc4cf89e1aac3d879eeada84`
:::
...
当你已经在 Developer Mode 中构建并 [测试你的应用](/mirror/apps-sdk/deploy/testing) 后，可以通过当前基于 dashboard 的审核流程提交它。该流程仍是目前公开分发的路径。当你发布获批应用时，OpenAI 会为 Codex distribution 创建 plugin。
...
Self-serve plugin publishing 即将推出。请参阅 [build plugins guide](/mirror/codex/plugins/build)，了解 packaging model 和 local testing workflow。

_提交前，请阅读并确保你的 app 符合我们的 [App Submission Guidelines](/mirror/apps-sdk/app-submission-guidelines)。_
...
- 你没有使用本地或测试 endpoint
- 你定义了 [content security policy (CSP)](/mirror/apps-sdk/build/mcp-server#content-security-policy-csp)，以允许你获取内容的确切 domains（出于安全原因，这是提交 app 的必需项）
...
Once you have built and [tested your app](/mirror/apps-sdk/deploy/testing) in Developer Mode, you can submit it through the current dashboard-based review flow. That flow remains the path to public distribution today. When you publish an approved app, OpenAI creates the plugin for Codex distribution.
...
Self-serve plugin publishing is coming soon. See the [build plugins guide](/mirror/codex/plugins/build) for the packaging model and local testing workflow.

_Before submitting, read and ensure your app complies with our [App Submission Guidelines](/mirror/apps-sdk/app-submission-guidelines)._
...
- You defined a [content security policy (CSP)](/mirror/apps-sdk/build/mcp-server#content-security-policy-csp) to allow the exact domains you fetch from (this is required to submit your app for security reasons)
