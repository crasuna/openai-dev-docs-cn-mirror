...
- [**ChatGPT apps 的 UX principles**](/mirror/apps-sdk/concepts/ux-principles) - 本指南概述了构建 ChatGPT apps 的原则和最佳实践，并提供一份清单，帮助你确保应用非常适合 ChatGPT。
- [**ChatGPT apps 的 UI guidelines**](/mirror/apps-sdk/concepts/ui-guidelines) - 本指南描述了交互、布局和设计模式，这些模式能帮助应用在 ChatGPT 中感觉直观、可信且一致。
...
[Instant Checkout](/mirror/commerce/guides/get-started#instant-checkout) 当前处于 beta，目前只面向部分 marketplace partner 开放，未来可能扩展到更多 marketplace 和 retailer。
