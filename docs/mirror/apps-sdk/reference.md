...
实现 walkthroughs 请参见 [build a ChatGPT UI](/mirror/apps-sdk/build/chatgpt-ui)。
...
这些 resource settings 的更多细节位于 [Advanced section of the MCP server guide](/mirror/apps-sdk/build/mcp-server#advanced)。
...
[Advanced section of the MCP server guide](/mirror/apps-sdk/build/mcp-server#advanced) 对这些 response fields 的组织方式提供了更多指导。
...
更广泛的 client-supplied hints 背景请参见 [Advanced section of the MCP server guide](/mirror/apps-sdk/build/mcp-server#advanced)。
