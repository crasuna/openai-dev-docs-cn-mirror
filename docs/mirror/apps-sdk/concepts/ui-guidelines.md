...
::: warning 非官方本地镜像
- 官方来源：[https://developers.openai.com/apps-sdk/concepts/ui-guidelines](https://developers.openai.com/apps-sdk/concepts/ui-guidelines)
- Markdown 来源：[https://developers.openai.com/apps-sdk/concepts/ui-guidelines.md](https://developers.openai.com/apps-sdk/concepts/ui-guidelines.md)
- 抓取时间：2026-06-27T05:54:45.924Z
- Checksum：`1aaf29efbae1478705ef26bc2c0c05c668053ece5351296d8ffcd8af1f0b6cc4`
:::
...
在开始为应用进行视觉设计前，请确保你已经阅读我们推荐的 [UX principles](/mirror/apps-sdk/concepts/ux-principles)。

![ChatGPT 移动端界面中的示例应用](/openai-assets/developers.openai.com/images/apps-sdk/overview.png)
...
Display modes 是开发者用来在 ChatGPT 中为 apps 创建体验的 surfaces。它们让合作伙伴能够展示内容和动作，同时感觉原生于对话。每种 mode 都为特定类型的交互而设计，从快速确认到沉浸式工作流。

一致地使用这些模式有助于让体验保持简单且可预测。

### Inline

inline display mode 会直接出现在对话流中。Inline surfaces 当前总是出现在生成的模型响应之前。每个应用最初都会以 inline 形式出现。

![ChatGPT 中 inline cards 和 carousels 示例](/openai-assets/developers.openai.com/images/apps-sdk/inline_display_mode.png)
...
![Inline cards 示例](/openai-assets/developers.openai.com/images/apps-sdk/inline_cards.png)
...
![Inline cards 图解](/openai-assets/developers.openai.com/images/apps-sdk/inline_card_layout.png)
...
![Inline cards 交互模式图解](/openai-assets/developers.openai.com/images/apps-sdk/inline_card_interaction.png)
...
![Inline cards 中应避免的模式示例](/openai-assets/developers.openai.com/images/apps-sdk/inline_card_rules.png)

#### Inline carousel

一组并排呈现的 cards，让用户快速浏览并从多个选项中选择。

![Inline carousel 示例](/openai-assets/developers.openai.com/images/apps-sdk/inline_carousel.png)
...
![Inline carousel 布局图解](/openai-assets/developers.openai.com/images/apps-sdk/inline_carousel_layout.png)
...
![Fullscreen 示例](/openai-assets/developers.openai.com/images/apps-sdk/fullscreen.png)
...
![Fullscreen 布局图解](/openai-assets/developers.openai.com/images/apps-sdk/fullscreen_layout.png)
...
![Fullscreen 交互模式](/openai-assets/developers.openai.com/images/apps-sdk/fullscreen_interaction_a.png)
...
![Picture-in-picture 示例](/openai-assets/developers.openai.com/images/apps-sdk/pip.png)
...
![Picture-in-picture 交互模式](/openai-assets/developers.openai.com/images/apps-sdk/fullscreen_interaction.png)
...
![Color palette](/openai-assets/developers.openai.com/images/apps-sdk/color.png)
...
![Color usage 示例](/openai-assets/developers.openai.com/images/apps-sdk/color_usage_1.png)

_在 accents 和 badges 上使用品牌色。不要更改文本颜色或其他核心组件样式。_

![Color usage 示例](/openai-assets/developers.openai.com/images/apps-sdk/color_usage_2.png)
...
![Typography](/openai-assets/developers.openai.com/images/apps-sdk/typography.png)
...
![Typography 示例](/openai-assets/developers.openai.com/images/apps-sdk/typography_usage.png)
...
![Spacing & layout](/openai-assets/developers.openai.com/images/apps-sdk/spacing.png)
...
![Icons](/openai-assets/developers.openai.com/images/apps-sdk/icons.png)
...
![Icons & imagery](/openai-assets/developers.openai.com/images/apps-sdk/iconography.png)
...
Before you start designing your app visually, make sure you have reviewed our
  recommended [UX principles](/mirror/apps-sdk/concepts/ux-principles).

![Example apps in the ChatGPT mobile interface](/openai-assets/developers.openai.com/images/apps-sdk/overview.png)
...
![Examples of inline cards and carousels in ChatGPT](/openai-assets/developers.openai.com/images/apps-sdk/inline_display_mode.png)
...
![Examples of inline cards](/openai-assets/developers.openai.com/images/apps-sdk/inline_cards.png)
...
![Diagram of inline cards](/openai-assets/developers.openai.com/images/apps-sdk/inline_card_layout.png)
...
![Diagram of interaction patterns for inline cards](/openai-assets/developers.openai.com/images/apps-sdk/inline_card_interaction.png)
...
![Examples of patterns to avoid in inline cards](/openai-assets/developers.openai.com/images/apps-sdk/inline_card_rules.png)

#### Inline carousel

A set of cards presented side-by-side, letting users quickly scan and choose from multiple options.

![Example of inline carousel](/openai-assets/developers.openai.com/images/apps-sdk/inline_carousel.png)
...
![Diagram of inline carousel](/openai-assets/developers.openai.com/images/apps-sdk/inline_carousel_layout.png)
...
![Example of fullscreen](/openai-assets/developers.openai.com/images/apps-sdk/fullscreen.png)
...
![Diagram of fullscreen](/openai-assets/developers.openai.com/images/apps-sdk/fullscreen_layout.png)
...
![Interaction patterns for fullscreen](/openai-assets/developers.openai.com/images/apps-sdk/fullscreen_interaction_a.png)
...
![Example of picture-in-picture](/openai-assets/developers.openai.com/images/apps-sdk/pip.png)
...
![Interaction patterns for picture-in-picture](/openai-assets/developers.openai.com/images/apps-sdk/fullscreen_interaction.png)
...
![Example color usage](/openai-assets/developers.openai.com/images/apps-sdk/color_usage_1.png)

_Use brand colors on accents and badges. Don't change text colors or other core component styles._

![Example color usage](/openai-assets/developers.openai.com/images/apps-sdk/color_usage_2.png)
...
![Example typography](/openai-assets/developers.openai.com/images/apps-sdk/typography_usage.png)
