...
::: warning 非官方本地镜像
- 官方来源：[https://developers.openai.com/codex/config-sample](https://developers.openai.com/codex/config-sample)
- Markdown 来源：[https://developers.openai.com/codex/config-sample.md](https://developers.openai.com/codex/config-sample.md)
- 抓取时间：2026-06-27T05:54:56.263Z
- Checksum：`4a68a22ac7e135305f79f398ef2a48eb33a3964321b45f90c431ba14460bac84`
:::
...
::: v-pre
请将此示例配置作为起点。它包含 Codex 从 `config.toml` 读取的大多数 key，以及默认行为、必要时推荐的值和简短说明。

有关解释和指导，请参阅：

- [Config basics](/mirror/codex/config-basic)
- [Advanced Config](/mirror/codex/config-advanced)
- [Config Reference](/mirror/codex/config-reference)
- [Sandbox and approvals](/mirror/codex/agent-approvals-security#sandbox-and-approvals)
- [Managed configuration](/mirror/codex/enterprise/managed-configuration)

请将下面的片段作为参考。只将你需要的 key 和 section 复制到 `~/.codex/config.toml`（或项目范围的 `.codex/config.toml`）中，然后根据你的设置调整值。
