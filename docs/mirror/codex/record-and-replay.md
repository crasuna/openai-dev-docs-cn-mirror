...
::: warning 非官方本地镜像
- 官方来源：[https://developers.openai.com/codex/record-and-replay](https://developers.openai.com/codex/record-and-replay)
- Markdown 来源：[https://developers.openai.com/codex/record-and-replay.md](https://developers.openai.com/codex/record-and-replay.md)
- 抓取时间：2026-06-27T05:55:06.812Z
- Checksum：`d93f775603d2c2ea686bbcc806c4134749bfc7b08bf58bcbbf078b5b88863037`
:::
...
Record & Replay 是一种从演示工作流快速创建 skill 的方式。如果你想向团队分发一个独立、稳定的软件包，捆绑多个 skill，包含 app 集成，添加 MCP servers，或管理安装元数据，请把该工作流打包成自己的 plugin。参见 [Build plugins](/mirror/codex/plugins/build)。
...
[Build plugins](/mirror/codex/plugins/build).
