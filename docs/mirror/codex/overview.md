...
::: warning 非官方本地镜像
- 官方来源：[https://developers.openai.com/codex/overview](https://developers.openai.com/codex/overview)
- Markdown 来源：[https://developers.openai.com/codex/overview.md](https://developers.openai.com/codex/overview.md)
- 抓取时间：2026-06-27T05:55:04.381Z
- Checksum：`00c3a95eed5b5b137128e111f835f5414aa10a281264b3553638a3683c92eda8`
:::
...
Codex 是 OpenAI 面向软件开发的编码 agent。ChatGPT Plus、Pro、Business、Edu 和 Enterprise 计划都包含 Codex。它可以帮助你：

- **编写代码**：描述你想构建的内容，Codex 会生成符合你意图的代码，并适配你现有的项目结构和约定。

- **理解陌生代码库**：Codex 可以阅读并解释复杂或遗留代码，帮助你理解团队如何组织系统。

- **审查代码**：Codex 会分析代码，识别潜在 bug、逻辑错误和未处理的边界情况。

- **调试并修复问题**：当某些东西出错时，Codex 会帮助追踪失败、诊断根因，并建议有针对性的修复。
...
/&gt;
  ...
  &lt;LinkCard
    ...
    description="获取灵感，了解你可以用 Codex 构建什么。"
    variant="image"
    ctaLabel="了解更多"
  ...
  &lt;LinkCard
    title="社区"
    href="/community"
    description="阅读社区帖子，探索聚会，并与 Codex 构建者建立联系。"
    variant="image"
    ctaLabel="查看社区"
  ...
  &lt;LinkCard
    ...
    description="申请或提名维护者，以获取 API credits、带 Codex 的 ChatGPT Pro，以及选择性 Codex Security 访问权限。"
    variant="image"
    ctaLabel="了解更多"
