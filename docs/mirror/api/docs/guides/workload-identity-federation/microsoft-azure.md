---
title: "为 Microsoft Azure 配置工作负载身份联合"
...
::: warning 非官方本地镜像
- 官方来源：[https://developers.openai.com/api/docs/guides/workload-identity-federation/microsoft-azure](https://developers.openai.com/api/docs/guides/workload-identity-federation/microsoft-azure)
- Markdown 来源：[https://developers.openai.com/api/docs/guides/workload-identity-federation/microsoft-azure.md](https://developers.openai.com/api/docs/guides/workload-identity-federation/microsoft-azure.md)
- 抓取时间：2026-06-27T05:54:12.604Z
- Checksum：`cf83c5e05ca3c27e872299e9f1c21c1bcaee78fca681db1947e6fdb0f43de369`
:::
...
AKS 工作负载也可以使用 Azure Workload Identity，为附加到该工作负载的 managed identity 获取 Microsoft Entra
  ...
  projected Kubernetes service account token。请使用 [Azure managed identity](/mirror/api/docs/guides/workload-identity-federation/microsoft-azure#azure-managed-identity) 中的步骤配置 OpenAI workload identity
