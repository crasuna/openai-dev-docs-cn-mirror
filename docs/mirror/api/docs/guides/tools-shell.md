...
::: warning 非官方本地镜像
- 官方来源：[https://developers.openai.com/api/docs/guides/tools-shell](https://developers.openai.com/api/docs/guides/tools-shell)
- Markdown 来源：[https://developers.openai.com/api/docs/guides/tools-shell.md](https://developers.openai.com/api/docs/guides/tools-shell.md)
- 抓取时间：2026-06-27T05:54:10.680Z
- Checksum：`90c65ed261b95965ec8e4779d70a2c7729331aa6fb9600ee3cfdcc747797fe7d`
:::
...
- 由你托管并自行执行的 [local shell runtime](/mirror/api/docs/guides/tools-shell#local-shell-mode)。
...
请使用 [Skills guide](/mirror/api/docs/guides/tools-skills) 了解上传和版本控制详情。
...
Allowlisting domains 会引入安全风险，例如由 prompt
  ...
  攻击者无法用来接收外泄数据的 domains。使用此工具前，请仔细阅读下面的 [Risks and safety](/mirror/api/docs/guides/tools-shell#risks-and-safety) 部分。
...
关于数据控制的更多详情，请参阅 [ZDR and data residency](/mirror/api/docs/guides/your-data)。
...
有关旧版迁移详情，请参阅较早的 [Local shell guide](/mirror/api/docs/guides/tools-local-shell)。

## 将 local shell 与 Agents SDK 一起使用

如果你正在使用 [Agents SDK](/mirror/api/docs/guides/tools#usage-in-the-agents-sdk)，可以将自己的 shell executor implementation 传给 shell tool helper。
...
[OpenAI data controls](/mirror/api/docs/guides/your-data) 适用于 OpenAI 边界内。然而，通过网络连接传输到第三方服务的数据受其数据保留政策约束。请确保外部 endpoints 符合你的 residency、retention 和 compliance requirements。
