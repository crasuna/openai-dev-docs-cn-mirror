...
文件搜索支持多种文件格式，包括 `.pdf`、`.md` 和 `.docx`。有关受支持文件扩展名及其对应 MIME 类型的更多详细信息，请参见下面的[支持的文件](/mirror/api/docs/assistants/tools/file-search#supported-files)部分。
