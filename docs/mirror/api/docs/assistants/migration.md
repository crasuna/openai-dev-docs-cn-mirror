...
::: warning 非官方本地镜像
- 官方来源：[https://developers.openai.com/api/docs/assistants/migration](https://developers.openai.com/api/docs/assistants/migration)
- Markdown 来源：[https://developers.openai.com/api/docs/assistants/migration.md](https://developers.openai.com/api/docs/assistants/migration.md)
- 抓取时间：2026-06-27T05:53:56.515Z
- Checksum：`fe5b9b2c1738a8eafc66c7e93589d1b21074827466e9190a91b167a1e13d8ec1`
:::
...
Responses 更简单：发送 input items，并取回 output items。使用 Responses API，你还可以获得更好的性能，以及 [deep research](/mirror/api/docs/guides/deep-research)、[MCP](https://developers.openai.com/api/docs/guides/tools-remote-mcp) 和 [computer use](/mirror/api/docs/guides/tools-computer-use) 等新功能。此变化还让你可以管理 conversations，而不必传回 `previous_response_id`。
...
Reusable prompt 对象也正在被弃用。如果你使用这条迁移
  路径，请在长期集成中采用
  prompt 对象之前，查看 [prompts deprecation timeline](/mirror/api/docs/deprecations#2026-06-03-reusable-prompts)。
