...
| card_number_type | String enum | Yes | 卡号类型。优先使用 network tokens，并回退到 FPAN。更多详情请参见 [PCI Scope](/mirror/commerce/guides/production#security-and-compliance)。 | “fpan” or “network_token” | Must be “fpan” or “network_token” |
